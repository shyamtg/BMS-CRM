...
class FormDataSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        response = super(FormDataSerializer, self).to_representation(instance)
    ...
    def create(self, validated_data):
        try:
            ...
            with transaction.atomic():
                ...
                form_instance = super(FormSerializer, self).create(validated_data)
...
class UserFormMappingSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        response = super(UserFormMappingSerializer, self).to_representation(instance)
