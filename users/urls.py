...
urlpatterns = [
    ...
    url('logout/', views.UserLogoutAllView.as_view(), name='logout'),
    url('login/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    url('timezones/', views.TimezoneView.as_view(), name='timezones'),
    url('current_timezone/', views.CurrentTimezoneView.as_view(), name='current_timezone'),
    url('issu/', views.IsSuperuser.as_view(), name='issuperuser'),
]
